...
| daily_song | `data/weekly_song_candidates_review.json` | parity_input | true | 4 |
| daily_term | `data/weekly_harvest_review_candidates.json` | parity_input | true | 4 |
...
- `rollback_snapshot` はconsoleの既定入力に戻さず、rollback手順に従ってのみ参照する。
