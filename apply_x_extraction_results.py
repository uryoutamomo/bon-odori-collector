                ...
                if not isinstance(events, list) or not events: _issue(issues,"missing_events",no=no)
                    ...
                    for event in events:
                        ...
                        if event_ok and date.fromisoformat(dates[1]) < today:
                            _issue(issues,"date_in_past",no=no); past=True
                        if past:
                            continue
                        if event_ok:
                            outcome="report"
