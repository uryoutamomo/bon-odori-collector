...
SOURCES: tuple[ReviewSource, ...] = (
    ...
    ReviewSource(
        id="x_account_roster",
        title="X情報源アカウント一覧",
        path="data/x_account_console.json",
        rows_path="accounts",
        domain="X/RSS",
        key_fields=("handle",),
        title_fields=("handle", "display_name"),
        subtitle_fields=(
            "display_name",
            "manual_status",
            "roster_source_label",
        ...
        priority_fields=("manual_status", "usefulness_rank"),
        score_fields=("usefulness_score", "score"),
        action_fields=("manual_status",),
        source_decision_fields=("manual_status",),
        description_fields=("review_hint",),
        urls_fields=("profile_url",),
        option_values=("優先", "通常", "休止"),
    ),
    ReviewSource(
        id="event_poster_ocr",
        title="ポスター画像の読み取り待ち",
        path="data/event_poster_ocr_queue.json",
        rows_path="items",
        domain="開催日",
        key_fields=("id", "tweet_id"),
        title_fields=("text", "account_name"),
        subtitle_fields=("account", "date", "priority", "evidence_type"),
        priority_fields=("priority",),
        action_fields=("status",),
        source_decision_fields=("status",),
        description_fields=("review_hint", "text"),
        urls_fields=("url", "media_urls"),
        option_values=("ocr_done", "ocr_no_event", "ocr_unreadable", "hold"),
    ),
    ReviewSource(
        id="x_candidate_post",
